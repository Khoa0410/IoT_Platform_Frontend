  ...
  return (
    ...
    <div className="top-0 left-0 w-full z-10">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <h1 className="text-4xl font-extrabold text-gray-900">Welcome to IoT Platform</h1>
        <p className="mt-2 text-gray-600">Manage your devices and monitor your dashboard from one place.</p>
      </div>
